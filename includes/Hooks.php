 ...
 *  - filter `lw_img_site_host`             ( string $host ): string — overrides the host sent as the X-HIMG-Site request header on every API call (multisite, reverse proxies); defaults to home_url()'s host, site_url()'s when home has none
