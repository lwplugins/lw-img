 ...
 *  - action `lw_img_upload_skipped`       ( string $file_path, string $reason, array $context ) — context may hold attachment_id, original_size, new_size
 *  - action `lw_img_upload_failed`        ( string $file_path, string $error, array $context ) — context may hold attachment_id
