...
final class NoticeManagerTest extends MonkeyTestCase {
	...
	public static function callback_provider(): array {
		return [
			'LW static method string' => [ 'LightweightPlugins\\Img\\Admin\\AdminNotice::render', true ],
		...
		$GLOBALS['wp_filter'] = [
			'admin_notices'     => (object) [
				'callbacks' => [
					10 => [
						'a' => [ 'function' => $foreign ],
						'b' => [ 'function' => 'LightweightPlugins\\Img\\Admin\\AdminNotice::render' ],
					],
				],
			],
